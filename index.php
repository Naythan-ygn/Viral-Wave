                ...
                <div class="col-md-12">
                    ...
                    <div class="info-bar">
                        ...
                        <div class="info-bleft">
                            ...
                            <div class="info-bph">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--primary)"
                                ...
                                <div class="dropdown open text-drop">
                                    ...
                                    <div class="drop-bg dropdown-menu bg-dark" aria-labelledby="triggerId">
                                        <a class="dropdown-item" href="#">
                                            <img src="https://i.pinimg.com/564x/24/a3/af/24a3af7fc241c6c75bd0e5e8447a8c1e.jpg"
                                                alt="flag" width="20" height="15">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <img src="https://i.pinimg.com/564x/80/65/aa/8065aae906a04fd786b80aeaa551e74f.jpg"
                                                alt="Flag" width="20" height="15">
                                            <span class="info-btext">
                                                中文
                                            </span>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="sidebar offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                                ...
                                <div class="offcanvas-body d-flex flex-column flex-lg-row p-4 p-lg-0">
                                    <ul
                                        class="navbar-nav justify-content-center align-items-center fs-8 flex-grow-1 pe-3">
                                        ...
                                        <li class="nav-item mx-2">
                                            <a id="tcolor" class="nav-link" href="#information">Information</a>
                                        </li>

                                        <li class="nav-item mx-2">
                                            <a id="tcolor" class="nav-link" href="#service">Services</a>
                                        </li>

                                        <li class="nav-item mx-2">
                                            <a id="tcolor" class="nav-link" href="#Contactus">Contact Us</a>
                                        </li>
                                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="header text-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--primary)"
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- This is for Growing Number Count. -->
                        <div class="numberCount">
                            <div class="number-box">
                                Reviews by
                                <span id="number">0</span> Millions
                            </div>

                            <div class="number-box">
                                Contents Over
                                <span id="number1">0</span> Millions
                            </div>

                            <div class="number-box">
                                Subscribed by
                                <span id="number2">0</span> Billions
                            </div>
                        </div>
                        ...
                        <div class="sponsorship">
                            ...
                            <div class="logos">
                                <div class="long-slide">
                                    <img src="https://purepng.com/public/uploads/large/purepng.com-ibm-logologobrand-logoiconslogos-251519939176ka7y8.png"
                                        alt="IBM">

                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Cisco_logo_blue_2016.svg/1280px-Cisco_logo_blue_2016.svg.png"
                                        alt="CISCO">

                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/F-Secure_Logo.png/1200px-F-Secure_Logo.png"
                                        alt="F-SECURE">
                                    ...
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Logo_da_Rolex.png/2560px-Logo_da_Rolex.png"
                                        alt="ROLEX">

                                    <img src="https://seeklogo.com/images/R/rolls-royce-logo-24811DB90B-seeklogo.com.png"
                                        class="bg-white" alt="RR">

                                    <img src="https://i0.wp.com/precisiondriversunlimited.com/wp-content/uploads/2018/03/toyota-logo-free-download-png.png?fit=1200%2C852&ssl=1&w=640"
                                        alt="toyota" height="100px">
                        ...
                        <h3 class="fw-bold text-center pt-4 text-decoration-underline">About Us</h3>
                        <div class="misvis">
                            <div class="misvis-text">
                                <h4 class="mis">Mission</h4>
                                <p class="text-black">
                                    Our <strong>mission</strong> is to focus on
                                    creating
                                    engaging and
                                    interactive
                                    content for teenagers. This purpose will empower teenagers to <strong>navigate the
                                        digital
                                        world
                                        safely and
                                        effectively</strong>.
                            ...
                            <div class="misvis-img">
                                <img src="https://cdn.uconnectlabs.com/wp-content/uploads/sites/33/2023/01/goals.png"
                                    alt="mission">
                            </div>
                        ...
                        <div class="misvis">
                            <div class="misvis-img">
                                <img src="https://static.vecteezy.com/system/resources/previews/011/429/649/non_2x/leadership-flat-illustration-personal-development-job-promotion-career-growth-concept-office-leader-holding-red-flag-and-running-cartoon-character-flat-modern-illustration-vector.jpg"
                                    alt="mission">
                            </div>
                            <div class="misvis-text">
                                <h4 class="vis">Future Vision</h4>
                                <p class="text-black">
                                    We provide a wide range of services, including interactive safety workshops digital
                                    safety
                                    mentor program, safe social media challenge platform, and more. Our team of
                                    <strong>experts</strong> is committed to providing
                                    <strong>high-quality content and services that meet the needs of our
                                        clients</strong>.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="pricing">
                            <h3 class="text-center fw-bold text-decoration-underline my-3">Choose Your Plan</h3>
                            <div class="container my-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-4 mb-4">
                                        <div class="card text-center h-100" id="basic">
                                            <div class="card-body">
                                                <h3 class="card-title">FREE</h3>
                                                <p class="display-4">$ 0 <span class="text-muted fs-5">current
                                                        plan</span></p>
                                                <ul class="text-light list-unstyled">
                                                    <li>1 User</li>
                                                    <li>512Mb Disk Space</li>
                                                    <li class="text-muted"><del>Email support</del></li>
                                                    <li class="text-muted"><del>Newsletter</del></li>
                                                    <li>Web Services</li>
                                                    <li class="text-muted"><del>Parent Hub</del></li>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="card text-center h-100" id="standard">
                                            <div class="card-body">
                                                <h3 class="card-title">STANDARD</h3>
                                                <p class="display-4">$23 <span class="text-muted fs-5">monthly</span>
                                                </p>
                                                <ul class="text-light list-unstyled">
                                                    <li>1 User</li>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="card text-center h-100" id="premium">
                                            <div class="card-body">
                                                <h3 class="card-title">PREMIUM</h3>
                                                <p class="display-4">$35 <span class="text-muted fs-5">monthly</span>
                                                </p>
                                                <ul class="text-light list-unstyled">
                                                    <li>1 User</li>
                                                    <li>1Gb Disk Space</li>
        ...
        <section id="service">
            ...
            <div class="service">
                <div class="card ser-card">
                    <img src="https://www.aip-foundation.org/wp-content/uploads/2022/10/52441442818_45fc917a05_o-scaled.jpg"
                ...
                <div class="card ser-card">
                    <img src="https://clinicaltrialsalliance.org.au/wp-content/uploads/2021/04/people-sitting-around-a-table-1024x683.jpeg"
                        class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="card ser-card">
                    <img src="https://www.socialchamp.io/wp-content/uploads/2021/08/Feature-Banner_JulyOnwards-Q3-2021_1125x600_10.png"
                        class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <section id="Contactus">
            <div class="container mb-5">
                <div class="row align-items-stretch no-gutters contact-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group mt-4">
                                        <input type="submit" value="Send Message"
                                            class="btn btn-danger rounded-4 py-2 px-4">
                    ...
                    <div class="col-md-6">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1350.3765435649884!2d96.14146588512875!3d16.804432573562547!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1eb5b34c3e1e7%3A0x3868066c7b2c32d3!2sStrategy%20First%20University%20-%20Teaching%20Centre%202%20(UWisara)!5e0!3m2!1sen!2smm!4v1719323267399!5m2!1sen!2smm"
